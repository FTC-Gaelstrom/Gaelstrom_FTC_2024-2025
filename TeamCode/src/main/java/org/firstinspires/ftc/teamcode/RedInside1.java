...
public class RedInside1 extends LinearOpMode{
    ...
    static final double COUNTS_PER_MOTOR_REV = 537.8;    // eg: goBILDA Motor Encoder
    ...
    public void runOpMode() {
        ...
        robot.planeMotor.setDirection(DcMotor.Direction.FORWARD);
        robot.spinnerMotor.setDirection(DcMotor.Direction.FORWARD);
